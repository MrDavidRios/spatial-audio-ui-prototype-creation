...
const columnInput = document.getElementById('columnInput') as HTMLInputElement;

const updateButton = document.querySelector('button');

const mainElement = document.querySelector('main');

const getCookieValue = (name: string) => document.cookie.match('(^|;)\\s*' + name + '\\s*=\\s*([^;]+)')?.pop() || undefined;
