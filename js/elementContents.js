...
export function getContents(elementType) {
    ...
    switch (elementType) {
        case 'p':
            if (option === 0)
                return '<p additionalSoundbite="personal-projects-p">I have worked on two separate projects in the past year.</p>';
            if (option === 1)
                return '<p additionalSoundbite="work-history-p">I was a senior developer in x company for the last 10 years.</p>';
            //If option === 2
            return '<p additionalSoundbite="hobbies-p">My hobbies include woodworking, pottery, and reading.</p>';
        case 'h1':
            if (option === 0)
                return '<h1 additionalSoundbite="personal-projects">Personal Projects</h1>';
            if (option === 1)
        ...
        case 'img':
            ...
            if (option === 1)
                return '<img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" additionalSoundbite="profile-picture"></img>';
            //If option === 2
